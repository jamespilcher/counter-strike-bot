const { getVoiceConnection, entersState, joinVoiceChannel, createAudioPlayer, createAudioResource, AudioPlayerStatus, VoiceConnectionStatus } = require('@discordjs/voice');
...
async function joinAndPlaySound(interaction, sound_file) {
    ...
    await new Promise(resolve => audioplayer.once(AudioPlayerStatus.Idle, resolve));
}
